...
import { FaVideo, FaEnvelope, FaLock, FaUser, FaSpinner, FaGift } from 'react-icons/fa';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center px-6 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 mt-2">Create your free account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="flex items-center justify-center gap-2 text-green-600 mb-6">
            <FaGift />
            <span className="text-sm font-medium">Get 100 free credits on signup!</span>
          </div>
        ...
        <div className="mt-8 bg-white/10 backdrop-blur-md rounded-xl p-6 text-white">
          ...
          <ul className="space-y-2 text-sm text-white/90">
            <li>✓ 100 free credits ($10 value)</li>
